...
HD_PWD='D:/PSN/VHDL/Proiect_JocProbabilitate/Proiect_JocProbabilitate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log placa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source placa.tcl -notrace
