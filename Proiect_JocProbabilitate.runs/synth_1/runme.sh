...
HD_PWD='D:/PSN/VHDL/Proiect_JocProbabilitate/Proiect_JocProbabilitate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log placa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source placa.tcl
